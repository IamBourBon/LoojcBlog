...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['sub_action'] == 'del_sub') {
        
        $sub->n_sub_id = $_POST['sub_id'];
        
        if ($sub->delete()) {
            $flag = "Delete subscribers success";
        }
    }
}
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Del_category<?php echo $rows['n_sub_id'] ?>">Delete</button>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
                ...
                ?>
                        ...
                        <div class="modal fade" id="Del_category<?php echo $rows['n_sub_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="modal-footer">
                                            <input type="hidden" name="sub_action" value="del_sub">
