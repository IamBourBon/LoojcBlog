                                    ...
                                    <form action="./blog.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-11">
                                                <input type="text" id="title" name="title" placeholder="Enter Title category" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-11">
                                                <textarea name="blog_summary" id="summernote_summary" rows="9" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-11">
                                                <textarea name="blog_content" id="summernote_content" rows="9" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-11">
                                                <input type="text" id="blog_path" name="blog_path" placeholder="Enter Title category" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="hidden" name="blog_action" value="Write_blog">
