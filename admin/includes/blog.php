...
class blog{
	...
	public function read_same_category(){
		$sql = "SELECT * FROM $this->table WHERE n_category_id= :c_id";
	...
	{
		$sql = "SELECT MIN(n_blog_post_id),blog_post.* FROM $this->table WHERE n_blog_post_id > :id ";
	...
	public function MostViewBlog()
	{
		$sql = "SELECT * FROM $this->table WHERE n_blog_post_views > 0 
				ORDER BY n_blog_post_views DESC LIMIT 3 ";
	...
	public function ThreeLastestBlog()
	{
		$sql = "SELECT * FROM blog_post ORDER BY n_blog_post_id DESC LIMIT 3";
	...
	public function LastestBlog()
	{
		$sql = "SELECT * FROM blog_post ORDER BY n_blog_post_id DESC LIMIT 1";
