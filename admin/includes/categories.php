...
class category{
	...
	public function read_single(){
		...
		$this->v_category_image_url = $row['v_category_image_url'];
	...
	public function create(){
		...
		$query = "INSERT INTO $this->table
		          SET v_category_title = :category_title,
		          	  ...
		          	  v_category_image_url = :category_img,
		...
		$stmt->bindParam(':category_img',$this->v_category_image_url);
