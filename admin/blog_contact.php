...
include "./includes/blog_contact.php";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['contact_action'] == 'del_contact') {
        
        $contact->n_contact_id = $_POST['contact_id'];
        
        if ($contact->delete()) {
            $flag = "Delete contact success";
        }
    }
}
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $rows['v_favorite'] ?></td>
                                                    <td><?php echo $rows['v_message'] ?></td>
                                                    <td>
                                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Del_category<?php echo $rows['n_contact_id'] ?>">Delete</button>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
                ...
                ?>
                        ...
                        <div class="modal fade" id="Del_category<?php echo $rows['n_contact_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="mediumModalLabel">Delete Contact</h5>
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="modal-footer">
                                            <input type="hidden" name="contact_action" value="del_contact">
