...
include "./admin/includes/blog_comment.php";
...
if(isset($_POST['submit_comment'])){
    ...
    $comment->d_time_created = date('y-m-d',time());
    $comment->create();
}
...
?>
                  ...
                  <div class="container-fluid px-0">
                      ...
                      <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                          <ul class="navbar-nav navbar-nav-hover ms-auto">
                              ...
                              <li class="nav-item dropdown dropdown-hover mx-2">
                                  <a href="./category.php" class="nav-link ps-2 d-flex cursor-pointer align-items-center" >
  ...
  <header>
      ...
      <div class="page-header min-vh-100" style="background-image: url('./assets/img/header/header2.png');" loading="lazy">
